...
# ====== 全局可配置参数（可直接在此处修改） ======
USER_NAME = "guanguan"         # 用户名
UUID = "10e016da-2e58-4213-bd22-1a4cbeceedd1"                     # UUID，留空则自动生成
PORT = 28968                   # Vmess端口，留空或0则自动生成
DOMAIN = "gg.gxr.dpdns.org"                   # 域名，留空则自动获取
CF_TOKEN = "eyJhIjoiMjUzNzEwOGI2MWEyNjc0YmI3OTYwNTlmYzQ3NmM5NjkiLCJ0IjoiM2M3NWM0OTYtMGFkZC00Y2M1LThiN2EtYWQxMWE5ZjRkNmI3IiwicyI6Ill6STVPRGhoT1RRdE5qWmhPUzAwTXpReExUZ3hPV0l0WVRJeE5UVXhaalUyWmpBMSJ9"                 # Cloudflare Token，留空则用Quick Tunnel
# =========================================
